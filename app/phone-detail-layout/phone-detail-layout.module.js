...
exports.default = angular.module('phonecat.layout.detail', ['ngAnimate'])
    .directive('phoneDetailLayout', upgrade_adaptor_module_1.upgradeAdapter.downgradeNg2Component(phone_detail_layout_component_1.default)).controller('DetailLayoutController', phone_detail_layout_component_1.default);
